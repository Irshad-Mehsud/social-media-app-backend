...
var _index = _interopRequireDefault(require("../models/user/models/index.js"));
...
// Corrected to singular 'user'

var protect = exports.protect = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          ...
          _context.n = 2;
          return _index["default"].findById(decoded.id).select('-password');
        case 2:
          req.user = _context.v;
          if (req.user) {
            _context.n = 3;
